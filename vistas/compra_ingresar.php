                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-sm-12">
                                  ...
                                  <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#proveedorModal">Agregar Proveedor</button>
                                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#productoModal">Agregar Productos</button>
                                ...
                                <table class="table table-bordered table-striped mt-4">
                                  ...
                                  <tfoot>
                                    <tr>
                                      ...
                                      <td id="total">0.00</td>
                                      <td><input type="hidden" name="total" id="totalInput"></td>
                                    </tr>
                                  </tfoot>
                                </table>
                                <!--/div-->
                                <div class="">
                                  <input type="submit" value="Guardar" class="btn btn-primary" name="btnGuardarCompra" id="btnGuardarCompra">
                          ...
                          <div class="form-group">
                            <div class="row">
                              <div class="col-sm-12" id="datosproveedor">
                                ...
                                <input type="text" class="form-control mb-2" name="idproveedor" id="idproveedor" readonly>
                                <label for="nombrep">Proveedor</label>
                                <input type="text" class="form-control mb-2" name="nombrep" id="nombrep" readonly>
                                <label for="nit">Nit</label>
                                <input type="text" class="form-control mb-2" name="nit" id="nit" readonly>
                                <label for="impuesto">Impuesto</label>
                                <input type="text" class="form-control mb-2" name="impuesto" id="impuesto" required>
                                <label for="tipocomprobante">Tipo Comprobante</label>
                                <select class="form-control mb-2" name="tipocomprobante" id="tipocomprobante" style="width: 100%;" onchange="actualizarInputs()" required>
                                  <option value="">Seleccionar</option>  
                                  <option value="factura">Factura</option>
                                  <option value="comprobante pago">Comprobante pago</option>
                                </select>
                                <label for="ncomprobante">Numero de Comprobante</label>
                                <input type="text" class="form-control mb-2" name="ncomprobante" id="ncomprobante" readonly>
                                <label for="scomprobante">Serie de Comprobante</label>
                                <input type="text" class="form-control mb-2" name="scomprobante" id="scomprobante" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <select name="producto" id="producto" class="form-control mb-2" style="width: 100%;">
                      <?php
                    ...
                    <input type="number" id="unidadm" class="form-control mb-2" placeholder="Unidad medida">
                    <input type="number" id="cantidadm" class="form-control mb-2" placeholder="Cantidad medida">
                    <input type="number" id="precio" class="form-control mb-2" placeholder="Precio">
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="agregarProductos()">Agregar</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="modal fade" id="proveedorModal" tabindex="-1" role="dialog" aria-labelledby="proveedorModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <select name="proveedor" id="proveedor" class="form-control mb-2" style="width: 100%;">
                      <?php
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="agregarProveedor()">Agregar</button>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  ...
  function agregarProductos() {
    ...
    var fila = "<tr><td>" + idproducto + "</td><td>" + texprod + "</td><td>" + cantidad + "</td><td>" + unidadm + "</td><td>" + cantidadm + "</td><td>" + precio.toFixed(2) + "</td><td><button type='button' class='btn btn-danger btn-sm' onclick='eliminarFila(this)'>Eliminar</button></td></tr>";
...
<script>
  function actualizarInputs() {
    ...
    $.ajax({
      ...
      type: 'POST',
      data: { tipocomprobante: seleccionado },
      dataType: 'json',
