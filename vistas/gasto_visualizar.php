                ...
                <form role="form" method="post" action="">
                  ...
                  <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <?php
                         echo "
                        <input type='text' class='form-control' placeholder='Empleado' value='$completo' name='nombre' id='nombre'
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <?php
                         echo "
                        <input type='text' class='form-control' placeholder='Fecha' value='$fecha' name='fecha' id='fecha'
                        pattern='^[a-zA-Záéíóú0-9]{1,30}' disabled required minlength='3' maxlength='15'>";
                        ?>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <?php
                         echo "
                        <input type='text' class='form-control' placeholder='Rol' value='$monto' name='monto' id='monto'
                        pattern='^[a-zA-Záéíóú0-9]{1,30}' disabled required minlength='3' maxlength='15'>";
                        ?>
                      </div>
                    </div> 
