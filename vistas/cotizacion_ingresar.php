...
?>
<script src="../js/cotizacioninsertar.js"></script>
                               ...
                               <div class="card-body" style="display: block;">
                                   ...
                                   <div class="container-fluid" style="font-size: 12px">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class=""><center>
                                                <input type="button" class="btn btn-success" value="Agregar Producto"  onclick="agregarCotizacion()">
                   ...
                   <div class="row">
                       <div class="col-md-50">
                           <div class="card card-outline card-primary">
                               ...
                               <div class="table table-responsive">
                                            <table id="tablaCotizaciones" class="table table-bordered table-striped table-sm">
                                                <thead>
                                                <tr>
                               ...
                               <form role="form" method="post" action="../crud/cotizacioningresar.php" onsubmit="return validarFormulario()">
                               <div class="card-body">
                                   ...
                                   <input type="hidden" id="datosTabla" name="datosTabla">
                                       ...
                                       <div class="col-md-12">
                                           <div class="form-group">
                                               ...
                                               <input type="number" step="any" name="sub_total" id="sub_total" style="text-align: center" class="form-control" required>
                                           </div>
                                       </div>
                                       <div class="col-md-12">
                                           <div class="form-group">
                                   ...
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <button type="submit" class="btn btn-primary btn-block" name="btnGuardarCotizacion" id="btnGuardarCotizacion">Guardar Cotización</button>
                                       </div>
                                   </div>
